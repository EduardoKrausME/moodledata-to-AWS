...
$aws_s3_mapping = array(
    ...
    'S3Filedir'     => dirname ( __DIR__ . '/../..' ) . '/S3Filedir.php',
    'S3Lib'         => dirname ( __DIR__ . '/../..' ) . '/S3Lib.php',
    'S3Theme'       => dirname ( __DIR__ . '/../..' ) . '/S3Theme.php',
...
spl_autoload_register (
    function ( $class ) use ( $aws_s3_mapping ) {
        if ( isset( $aws_s3_mapping[ $class ] ) )
            require $aws_s3_mapping[ $class ];
    }, true );
